...
/**
 * Class Client_adresseFacturationType
 * @package whiteLabel\BackOfficeBundle\Form
 */
class Client_adresseFacturationType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class'    => 'whiteLabel\BackOfficeBundle\Entity\Client_adresseFacturation',
            'trait_choices' => null
        ));
    }
    ...
    {
        return 'whitelabel_backofficebundle_client_adressefacturation';
    }
